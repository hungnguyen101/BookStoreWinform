...
namespace BookStoreWinform.AccountService {
    ...
    public interface IAccount {
        ...
        BookStoreWinform.AccountService.Account[] findAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelOf_Account/findAll", ReplyAction="http://tempuri.org/IModelOf_Account/findAllResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account[]> findAllAsync();
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(BookStoreWinform.AccountService.Account[]))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(BookStoreWinform.AccountService.Account))]
        BookStoreWinform.AccountService.Account findById(object id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelOf_Account/findById", ReplyAction="http://tempuri.org/IModelOf_Account/findByIdResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account> findByIdAsync(object id);
        ...
        long insert(BookStoreWinform.AccountService.Account entity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelOf_Account/insert", ReplyAction="http://tempuri.org/IModelOf_Account/insertResponse")]
        System.Threading.Tasks.Task<long> insertAsync(BookStoreWinform.AccountService.Account entity);
        ...
        bool update(BookStoreWinform.AccountService.Account entity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelOf_Account/update", ReplyAction="http://tempuri.org/IModelOf_Account/updateResponse")]
        System.Threading.Tasks.Task<bool> updateAsync(BookStoreWinform.AccountService.Account entity);
        ...
        BookStoreWinform.AccountService.Account Authenticate(string username, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccount/Authenticate", ReplyAction="http://tempuri.org/IAccount/AuthenticateResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account> AuthenticateAsync(string username, string password);
        ...
        BookStoreWinform.AccountService.Account[] findAccountsByGroup(string groupID);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountChannel : BookStoreWinform.AccountService.IAccount, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountClient : System.ServiceModel.ClientBase<BookStoreWinform.AccountService.IAccount>, BookStoreWinform.AccountService.IAccount {
        ...
        public BookStoreWinform.AccountService.Account[] findAll() {
            return base.Channel.findAll();
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account[]> findAllAsync() {
            return base.Channel.findAllAsync();
        }
        
        public BookStoreWinform.AccountService.Account findById(object id) {
            return base.Channel.findById(id);
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account> findByIdAsync(object id) {
        ...
        public BookStoreWinform.AccountService.Account Authenticate(string username, string password) {
            return base.Channel.Authenticate(username, password);
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.AccountService.Account> AuthenticateAsync(string username, string password) {
            return base.Channel.AuthenticateAsync(username, password);
        }
        
        public BookStoreWinform.AccountService.Account[] findAccountsByGroup(string groupID) {
