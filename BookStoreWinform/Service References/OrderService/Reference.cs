...
namespace BookStoreWinform.OrderService {
    ...
    public interface IOrder {
        ...
        BookStoreWinform.OrderService.Order[] findOrderByAccount(long id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/findOrderByAccount", ReplyAction="http://tempuri.org/IOrder/findOrderByAccountResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order[]> findOrderByAccountAsync(long id);
        ...
        BookStoreWinform.OrderService.Order[] findAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/findAll", ReplyAction="http://tempuri.org/IOrder/findAllResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order[]> findAllAsync();
        ...
        BookStoreWinform.OrderService.Order findById(long id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/findById", ReplyAction="http://tempuri.org/IOrder/findByIdResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order> findByIdAsync(long id);
        ...
        bool insert(BookStoreWinform.OrderService.Order entity, BookStoreWinform.OrderService.DetailOrder[] items);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/insert", ReplyAction="http://tempuri.org/IOrder/insertResponse")]
        System.Threading.Tasks.Task<bool> insertAsync(BookStoreWinform.OrderService.Order entity, BookStoreWinform.OrderService.DetailOrder[] items);
        ...
        bool update(BookStoreWinform.OrderService.Order entity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/update", ReplyAction="http://tempuri.org/IOrder/updateResponse")]
        System.Threading.Tasks.Task<bool> updateAsync(BookStoreWinform.OrderService.Order entity);
        ...
        BookStoreWinform.OrderService.DetailOrder[] findDetailByOrder(long id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrder/findDetailByOrder", ReplyAction="http://tempuri.org/IOrder/findDetailByOrderResponse")]
        System.Threading.Tasks.Task<BookStoreWinform.OrderService.DetailOrder[]> findDetailByOrderAsync(long id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IOrderChannel : BookStoreWinform.OrderService.IOrder, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class OrderClient : System.ServiceModel.ClientBase<BookStoreWinform.OrderService.IOrder>, BookStoreWinform.OrderService.IOrder {
        ...
        public BookStoreWinform.OrderService.Order[] findOrderByAccount(long id) {
            return base.Channel.findOrderByAccount(id);
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order[]> findOrderByAccountAsync(long id) {
            return base.Channel.findOrderByAccountAsync(id);
        }
        
        public BookStoreWinform.OrderService.Order[] findAll() {
            return base.Channel.findAll();
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order[]> findAllAsync() {
            return base.Channel.findAllAsync();
        }
        
        public BookStoreWinform.OrderService.Order findById(long id) {
            return base.Channel.findById(id);
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.OrderService.Order> findByIdAsync(long id) {
            return base.Channel.findByIdAsync(id);
        }
        
        public bool insert(BookStoreWinform.OrderService.Order entity, BookStoreWinform.OrderService.DetailOrder[] items) {
            return base.Channel.insert(entity, items);
        }
        
        public System.Threading.Tasks.Task<bool> insertAsync(BookStoreWinform.OrderService.Order entity, BookStoreWinform.OrderService.DetailOrder[] items) {
            return base.Channel.insertAsync(entity, items);
        }
        
        public bool update(BookStoreWinform.OrderService.Order entity) {
            return base.Channel.update(entity);
        }
        
        public System.Threading.Tasks.Task<bool> updateAsync(BookStoreWinform.OrderService.Order entity) {
        ...
        public BookStoreWinform.OrderService.DetailOrder[] findDetailByOrder(long id) {
            return base.Channel.findDetailByOrder(id);
        }
        
        public System.Threading.Tasks.Task<BookStoreWinform.OrderService.DetailOrder[]> findDetailByOrderAsync(long id) {
